...
| `SettingsReadingPanel.vue`                           | 「阅读」：字号/行高滑块、压缩空行保留一行、引号/括号跨行匹配、**启用粘性章节标题**、**滚动**（平滑滚动、**滚动倍率** `mouseWheelScrollSensitivity`、**滚动加速倍率** `fastScrollSensitivity` / 按住 Alt）、全屏正文区宽度、**定时滚动**（范围 **`RadioGroup`**：一屏/一行；间隔 **`NumericInput`** 毫秒）。<br>（`monacoCustomHighlight` 来自 props，用于禁用跨行开关提示）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
